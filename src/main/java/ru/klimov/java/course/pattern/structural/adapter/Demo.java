package ru.klimov.java.course.pattern.structural.adapter;

import ru.klimov.java.course.pattern.structural.adapter.adapters.SquarePegAdapter;
import ru.klimov.java.course.pattern.structural.adapter.round.RoundHole;
